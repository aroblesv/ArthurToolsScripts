...
if [[ "$CosM2Version" = "$EosM2Version" ]]; then
	echo -e "\033[0mM2: \033[32mDone\033[0m"
else
	echo -e "\033[0mM2: \033[33m\"Need update\"\033[0m | Current M2: \033[31m$CosM2Version\033[0m | M2 Requested: \033[33m$EosM2Version\033[0m"
fi
